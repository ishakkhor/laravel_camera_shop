...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $category->save();
        return redirect('admin/category')->with('message', 'Successfully Created');
    }
    ...
    public function show($id)
    {
       $allcategory = Category::all()->toArray();
        ...
        return view('frontend.pages.show_category',compact('allcategory', 'allbrand', 'allproduct'));  
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.pages.category.edit', compact('category', 'id'));
    }
